...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        Debug.Assert(!m_XRILeftHand.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRILeftHand.Disable() has not been called.");
        Debug.Assert(!m_XRILeftHandInteraction.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRILeftHandInteraction.Disable() has not been called.");
        Debug.Assert(!m_XRILeftHandLocomotion.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRILeftHandLocomotion.Disable() has not been called.");
        Debug.Assert(!m_XRIRightHand.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRIRightHand.Disable() has not been called.");
        Debug.Assert(!m_XRIRightHandInteraction.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRIRightHandInteraction.Disable() has not been called.");
        Debug.Assert(!m_XRIRightHandLocomotion.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRIRightHandLocomotion.Disable() has not been called.");
