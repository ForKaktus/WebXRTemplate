...
//     version 1.8.1
//     from Assets/WebXRInputActions.inputactions
//
...
namespace WebXR.InputSystem
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""bb13bea4-a2b0-43d3-8961-2d87851a2f49"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a7ec3a4e-89fc-49a8-ac1e-60c7230c7d86"",
                    ""path"": ""<XRController>{LeftHand}/tackpad"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""XR"",
                    ""action"": ""Touchpad"",
                ...
                {
                    ""name"": """",
                    ""id"": ""f230b028-9030-4925-ab53-f1c0e981b162"",
                ...
                {
                    ""name"": """",
                    ""id"": ""30d17c6f-442f-494a-98dd-f4fab98740e0"",
                ...
                {
                    ""name"": """",
                    ""id"": ""adb5a09f-7a92-48a9-a00f-a5f684308aae"",
                ...
                {
                    ""name"": """",
                    ""id"": ""bdd3efce-d806-4ec8-98ac-09587271796a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""40da890c-ce61-4ba6-8400-4430e59e3271"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ee69679e-e2fb-4f83-ae31-e33424d62968"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a320e65f-e97b-452e-96d3-779640307387"",
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""7344050f-5dc6-4ba8-b5f4-9419f3a3a381"",
                ...
                {
                    ""name"": """",
                    ""id"": ""fbe46b04-a62b-400c-aff4-59d898b0157c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""08a9dc64-9323-457f-ae9e-c4efae18ab00"",
                ...
                {
                    ""name"": """",
                    ""id"": ""86c66dee-3f04-463c-af5a-7d0def78b730"",
                ...
                {
                    ""name"": """",
                    ""id"": ""4b9ef3a4-64a5-4ed3-9f21-bd30dd3bd3df"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8a51fbb2-92f5-43c7-8921-a086d98aee5e"",
                    ""path"": ""<XRController>{RightHand}/tackpad"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""XR"",
                    ""action"": ""Touchpad"",
                ...
                {
                    ""name"": """",
                    ""id"": ""29819732-927d-4ecb-a13d-a699b0eab3aa"",
                ...
                {
                    ""name"": """",
                    ""id"": ""834dfeb5-fed9-4b91-a213-13e1ade38cc5"",
    ...
    ""controlSchemes"": [
        ...
        ~@WebXRInputActions()
        {
            Debug.Assert(!m_XRLeftHand.enabled, "This will cause a leak and performance issues, WebXRInputActions.XRLeftHand.Disable() has not been called.");
            Debug.Assert(!m_XRRightHand.enabled, "This will cause a leak and performance issues, WebXRInputActions.XRRightHand.Disable() has not been called.");
        }
